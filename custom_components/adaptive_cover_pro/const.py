...
# When True, the periodic reconciliation pass never resends a command on a
# position mismatch — the cover is commanded once and left where it lands.
# A settled landing-delta then surfaces as a manual override instead of a
# retry (issue #591). Default is DEFAULT_DISABLE_POSITION_MATCHING (section 20).
CONF_DISABLE_POSITION_MATCHING = "disable_position_matching"
...
# Default for CONF_DISABLE_POSITION_MATCHING (issue #591). False = matching on.
DEFAULT_DISABLE_POSITION_MATCHING = False
